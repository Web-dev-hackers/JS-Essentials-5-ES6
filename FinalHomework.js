...
const marks=[0,50,11,100,30,80,2,96,99,63];
...
const myClass=["Ghalya","bushra","Ash","Taha","Mohammed1","Mohammed2","Osama","Essam"];
...
const myClassWithIndex = myClass.map(function(result, ind){
    for(let i = 0; i < myClass.length; i++){
        result =  myClass[ind] + ind;
                 return  result;
             }
}); 
//after that uncomment the next line
