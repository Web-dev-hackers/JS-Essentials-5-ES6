...
let MyName = "Bushra" ;
var marks = [50,70,71,82,66,92,91,84,95,81]
//0.c Create array called 'myClass' consisting of strings that represent:
// -name of females in your class
// -name of males in your class
// -name of your class instructor ;)

let females = ["Ghalya","Zahra","Aisha"]
let males = ["Taha","Muhammed","Osama","Muhammed Z"]
let instructor = ["Essam"]
let myClass = [{females},{males},{instructor}]
...
let calculateAverage = (potato, tomato, callback =()=>{console.log("cmon")}) => {
    let sum= potato + tomato ;  
    let avg = sum / 2     
    callback (avg)    
}
