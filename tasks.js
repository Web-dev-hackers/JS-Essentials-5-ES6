...
let myName = "Bushra";
let myFriends =["Ranz","Ray","Ody","Jacob","Haj"];
...
let protectedSum = (potato, tomato, callback =()=>{console.log("we did it")}) => {
        let Sum = potato + tomato ;       
        callback (Sum)
}
//after that uncomment the next lines
protectedSum(19, 39, (Sum)=>{
console.log(Sum*2)
}) // you should  see an error on the console
